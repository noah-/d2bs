...
PatchHook Conditional[] = {
    ...
    {PatchBytes, GetDllOffset("D2CLIENT.DLL", 0x4EBFB),	(BYTE)0x75,	1},       					// Click OK on Congratz Screen
    {PatchBytes, GetDllOffset("D2CLIENT.DLL", 0x4660A),	(BYTE)0x09,	1}       					// Display Hell Diff After finishing Nightmare on Expansion Characters
};