...
FUNCPTR(D2CLIENT, GetMonsterOwner, DWORD __fastcall, (DWORD nMonsterId), 0x8E2B0)
...
ASMPTR(D2CLIENT, TestPvpFlag_I, 0x6A670)
...
FUNCPTR(D2COMMON, GetNextItemFromInventory, UnitAny *__stdcall, (UnitAny *pItem), 0x38130)
